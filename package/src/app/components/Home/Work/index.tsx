...
const settings = {
  ...
  autoplaySpeed: 2000,
  cssEase: "linear",
  pauseOnHover: false, // <-- AGGIUNTO: Non si ferma col mouse sopra
  pauseOnFocus: false, // <-- AGGIUNTO: Non si ferma se ci clicchi
  responsive: [
    {
      breakpoint: 1200,
      settings: {
    ...
    >
      <div className="container mx-auto max-w-7xl px-4">
        <div className="text-center overflow-hidden">
          <h3 className="text-black my-5">
            Gli sponsor che hanno creduto in noi
          </h3>
        </div>
      </div>
      ...
      <Slider {...settings}>
        {loading
          ...
          : work.map((items, i) => (
              <div key={i}>
                <div className="bg-white dark:bg-darkHeroBg m-3 py-8 my-10 text-center shadow-xl rounded-3xl">
                  ...
                  <h6 className="text-xl text-black dark:text-white font-bold pt-4">
                    {items.name}
                  </h6>
